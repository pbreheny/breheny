...
#'
#' Shares Amazon CloudFront file. Requires aws command line functionality and quite a bit of setup; see bin/cloud-share.
#'
#' @returns Either a url or R script. The latter is particularly useful for batch downloads and specifying file save paths.
#'
...
#' @param expiration   How long until URLs expire (in days)? Numeric.  Default: 365.
